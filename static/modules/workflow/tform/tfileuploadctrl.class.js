define('TFileUploadCtrl',function(require, exports, module){
    ...
    var TFileUploadCtrl = Base.extend({
        ...
        batch_upload:function(swfupload){
          ...
          var append_item_id = "&ITEM_ID="+this.item_id;//往window.upload_cfg1.upload_url追加ITEM_ID
          ...
          if(typeof(swfupload) == "undefined")
          {
              ...
              window.swfupload = new Object();
          }
          window.swfupload[this.item_id] = swfupload[this.item_id] = new SWFUpload(jQuery.extend(true, {}, settings, window.upload_cfg1));
        },
