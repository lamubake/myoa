        ...
        for(i=1;i<mytable.rows.length;i++)
        {
            ...
            for(k=0;k<cal_array.length-1;k++)
            {
                ...
                if(read_only == 1){
                    ...
                    if(cal_str=="" || !mytable.rows[i].cells[k].firstChild || (!(list_priv == "" || list_priv == null || typeof list_priv == "undefined") && list_priv[k] && list_priv[k]['priv'] >= 2)){
                        continue;
                    }
                }
...
function data_picker(obj,item_str,type)
{
	...
	var URL="/general/workflow/list/input_form/data_picker.php?dataSrc="+dataSrc+"&dataField="+dataField+"&dataFieldName="+dataFieldName+"&item_str="+item_str+"&type="+type+"&objName="+obj.name+"&dataQuery="+dataQuery+"&data_control="+data_control+"&dataSrcName="+dataSrcName+"&datadbid="+datadbid;
	var openWidth = 800;
  var openHeight = 450;
...
function list_data_picker(obj,table, field, fieldName, dataQuery)
{
	...
	var URL="/general/workflow/list/input_form/data_picker.php?dataSrc="+dataSrc+"&dataField="+field+"&dataFieldName="+fieldName+"&dataQuery="+dataQuery+"&all_id="+all_id_str+"&row_id="+row_id+"&LIST_VIEW=LIST_VIEW";
	var openWidth = 800;
    var openHeight = 450;
    var loc_x = (screen.availWidth - openWidth) / 2;
    var loc_y = (screen.availHeight - openHeight) / 2;
...
function data_fetch(obj,run_id,item_str)
{
    ...
    var args="dataSrc="+dataSrc+"&run_id="+run_id+"&data_field="+dataField+"&item_str="+item_str+"&data_fld_name="+data_fld_name+"&data_fld_class="+data_fld_class+"&data_fld_classname="+data_fld_classname;
