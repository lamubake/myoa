    ...
    if (typeof actionType != "undefined") {
        ...
        if (actionType == "handle") {
            ...
            jQuery(document).on('click', '#back_ok', function() {
                ...
                var back_data = 'email_check='+email_check_val+'&mobile_check='+mobile_check_val+'&msg_check='+sms_check_val+'&flow_id=' + flow_id + '&run_name=' + run_name + '&flow_prcs=' + flow_prcs + '&prcs_id=' + prcs_id + '&prcs_key_id=' + prcs_key_id + '&run_id=' + run_id + '&back_counter_singn=' + jQuery('#back_counter_singn').val() + '&allow_back=' + jQuery('#allow_back').val()
