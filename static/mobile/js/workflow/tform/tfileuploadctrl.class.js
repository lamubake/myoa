define('TFileUploadCtrl', function(require, exports, module){
    ...
    var TFileUploadCtrl = Base.extend({
        ...
        bindEvent: function() {
            var self = this;
            this.$list.delegate('span.fileupload-item', 'tap', function(e){
                e.stopPropagation();
                e.preventDefault();
        ...
        uploadImages: function() {
            ...
            window.upload_images(function(info){
                if(platform == "client"){
                    ...
                    self.getAttachInfo(tMobileSDK.imgServerId);
                }else if(platform == "dd"){
        ...
        getData: function() {
            ...
            if(self.$list.find('a.pda_attach').length > 0){
                self.$list.find('a.pda_attach').each(function(){
                    ...
                    ret.value.attach_name += attach_name+'*';
                });
            }
            ret.value = {
            ...
            if (required_val && ret.value.length==0) {
