// "/static/js/jquery-1.10.2/jquery.min.js","/static/js/bootstrap/js/bootstrap.min.js","/static/js/jquery-1.5.1/jBox/jquery.jBox-2.3.gbk.min.js","/static/js/jquery-1.5.1/jBox/i18n/jquery.jBox-zh-CN.gbk.js","/static/modules/workflow/js/jquery.browser.js","/static/js/jquery-1.5.1/tooltip/jquery.tooltip.min.js","/static/js/jquery-1.5.1/jsrender/jsrender.gbk.min.js","/static/js/jquery-1.10.2/jquery.ux.attachmenu.js","/static/modules/workflow/js/workflow.js","/general/approve_center/list/input_form/js/index.js","/general/approve_center/list/input_form/js/handle.js","/general/approve_center/assets/common.js"
    ...
    x.fn = x.prototype = {
        ...
        x.extend = x.fn.extend = function ()
        {
            var e, n, r, i, o, a, s = arguments[0] || {},
                ...
                u = arguments.length,
                c = !1;
            for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, l = 2), "object" == typeof s || x.isFunction(s) || (s = {}), u === l && (s = this, --l); u > l; l++) if (null != (o = arguments[l])) for (i in o) e = s[i],
                r = o[i],
    ...
    function (t)
    {
        ...
        e.prototype = {
            ...
            enforceFocus: function ()
            {
                ...
                {
                    if (e.$element[0] !== t.target && !e.$element.has(t.target).length)
                    {
                        e.$element.focus()
                    }
                })
            ...
            refresh: function ()
            {
                ...
                i = this.$body.find(this.selector).map(function ()
                {
                    var i = t(this),
                        ...
                        s = /^#\w/.test(n) && t(n);
                    return s && s.length && [
                            [s.position().top + (!t.isWindow(e.$scrollElement.get(0)) && e.$scrollElement.scrollTop()), n]
                        ] || null
                }).sort(function (t, e)
                {
                    return t[0] - e[0]
    ...
    function (t)
    {
        ...
        t.fn.button = function (i)
        {
            return this.each(function ()
            {
                ...
                if (i == "toggle") s.toggle();
                else if (i) s.setState(i)
            })
        };
    ...
    function (t)
    {
        ...
        t.fn.collapse = function (i)
        {
            return this.each(function ()
            {
                var n = t(this),
                    s = n.data("collapse"),
                    o = t.extend({}, t.fn.collapse.defaults, n.data(), typeof i == "object" && i);
        ...
        {
            var i = t(this),
                n, s = i.attr("data-target") || e.preventDefault() || (n = i.attr("href")) && n.replace(/.*(?=#[^\s]+$)/, ""),
                o = t(s).data("collapse") ? "toggle" : i.data();
...
!
    function (t)
    {
        ...
        t.fn.carousel = function (i)
        {
            return this.each(function ()
            {
                var n = t(this),
                    ...
                    a = typeof i == "string" ? i : o.slide;
                if (!s) n.data("carousel", s = new e(this, o));
                if (typeof i == "number") s.to(i);
                else if (a) s[a]();
                else if (o.interval) s.pause().cycle()
            })
        };
        ...
        {
            var i = t(this),
                n, s = t(i.attr("data-target") || (n = i.attr("href")) && n.replace(/.*(?=#[^\s]+$)/, "")),
    ...
    function (t)
    {
        ...
        e.prototype = {
            ...
            sorter: function (t)
            {
                ...
                while (s = t.shift())
                {
                    if (!s.toLowerCase().indexOf(this.query.toLowerCase())) e.push(s);
                    else if (~s.indexOf(this.query)) i.push(s);
                    else n.push(s)
                }
                return e.concat(i, n)
            },
...
(function (n, t, i)
{
    ...
    function ct(n, t, i)
    {
        return (!k.rTag || arguments.length) && (a = n ? n.charAt(0) : a, v = n ? n.charAt(1) : v, f = t ? t.charAt(0) : f, h = t ? t.charAt(1) : h, w = i || w, n = "\\" + a + "(\\" + w + ")?\\" + v, t = "\\" + f + "\\" + h, l = "(?:(?:(\\w+(?=[\\/\\s\\" + f + "]))|(?:(\\w+)?(:)|(>)|!--((?:[^-]|-(?!-))*)--|(\\*)))\\s*((?:[^\\" + f + "]|\\" + f + "(?!\\" + h + "))*?)", k.rTag = l + ")", l = new RegExp(n + l + "(\\/)?|(?:\\/(\\w+)))" + t, "g"), et = new RegExp("<.*>|([^\\\\]|^)[{}]|" + n + ".*" + t)),
            [a, v, f, h, w]
    }
    ...
    function ei(n, t)
    {
        ...
        } else if (s) while (r.parent.parent) u = r = r.parent;
        else while (r && !u) u = r.type === t ? r : i,
                r = r.parent;
        return u
    }
    ...
    function oi(n, t)
    {
        var u, f = this,
            r = t && t[n] || (f.ctx || {})[n];
        return r = r === i ? f.getRsc("helpers", n) : r,
        r && typeof r == "function" && (u = function ()
        {
    ...
    function si(n, t, u)
    {
        var h, f, o, e = +u === u && u,
            s = t.linkCtx;
        return e && (u = (e = t.tmpl.bnds[e - 1])(t.data, t, r)),
            o = u.args[0],
        (n || e) && (f = s && s.tag || {
                _: {
                    inline: !s
                ...
                flow: !0,
                _is: "tag"
            }, f._.bnd = e, s && (s.tag = f, u.ctx = c(u.ctx, s.view.ctx)), f.tagCtx = u, u.view = t, f.ctx = u.ctx || {}, delete u.ctx, t._.tag = f, n = n !== "true" && n, n && ((h = t.getRsc("converters", n)) || p("Unknown converter: {{" + n + ":")) && (f.depends = h.depends, o = h.apply(f, u.args)), o = e && t._.onRender ? t._.onRender(o, t, e) : o, t._.tag = i),
            o
    }

    function hi(n, t)
    {
        for (var e = this, u = r[n], f = u && u[t]; f === i && e;) u = e.tmpl[n],
            f = u && u[t],
            e = e.parent;
        return f
    }
    ...
    function ci(n, t, u, f)
    {
        var ft, s, et, nt, k, l, tt, it, h, d, y, ot, v, ut, w = "",
            ...
            st = u || t.tmpl,
            ht = t._;
        for (n._is === "tag" && (s = n, n = s.tagName), g && (f = (ot = st.bnds[g - 1])(t.data, t, r)), tt = f.length, s = s || a.tag, l = 0; l < tt; l++) h = f[l],
            y = h.tmpl,
            y = h.content = y && st.tmpls[y - 1],
            u = h.props.tmpl,
        l || u && s || (v = t.getRsc("tags", n) || p("Unknown tag: {{" + n + "}}")),
            u = u || (s ? s : v).template || y,
            u = "" + u === u ? t.getRsc("templates", u) || e(u) : u,
            o(h, {
                tmpl: u,
                render: rt,
                index: l,
        ...
        s || (v._ctr ? (s = new v._ctr, ut = !!s.init, s.attr = s.attr || v.attr || i) : s = {
            ...
            inline: !a
        }, a && (a.attr = s.attr = a.attr || s.attr, a.tag = s, s.linkCtx = a), (s._.bnd = ot || a) && (s._.arrVws = {}), s.tagName = n, s.parent = k = b && b.tag, s._is = "tag", s._def = v),
            ht.tag = s,
            h.tag = s,
            s.tagCtxs = f,
        s.flow || (d = h.ctx = h.ctx || {}, et = s.parents = d.parentTags = b && c(d.parentTags, b.parentTags) || {}, k && (et[k.tagName] = k), d.tag = s);
        for (s.rendering = {}, l = 0; l < tt; l++) h = s.tagCtx = f[l],
            s.ctx = h.ctx,
        !l && ut && (s.init(h, a, s.ctx), ut = i),
        (ft = s.render) && (it = ft.apply(s, h.args)),
            w += it !== i ? it : h.tmpl ? h.render() : "";
        return delete s.rendering,
            s.tagCtx = s.tagCtxs[0],
            s.ctx = s.tagCtx.ctx,
        s._.inline && (nt = s.attr) && nt !== "html" && (w = nt === "text" ? wt.html(w) : ""),
            g && t._.onRender ? t._.onRender(w, t, g) : w
    }
    ...
    function b(n, t, r, u, f, e, o, s)
    {
        ...
        return r && (c = r.views, l = r._, l.useKey ? (c[v.key = "_" + l.useKey++] = h, a = l.tag, v.bnd = y && (!a || !!a._.bnd && a)) : c.splice(v.key = h.index = e !== i ? e : c.length, 0, h), h.ctx = n || r.ctx),
            h
    }
    ...
    function at(r, u, f, o, s, h)
    {
        function v(i)
        {
            if ("" + i === i || i.nodeType > 0)
            {
                ...
                return a && (i = a.getAttribute(ht), r = r || i, i = e[i], i || (r = r || "_" + ui++, a.setAttribute(ht, r), i = e[r] = at(r, a.innerHTML, f, o, s, h))),
                    i
            }
        }
    ...
    function vt(n, t)
    {
        ...
        return t.htmlTag || (i = ii.exec(n), r.htmlTag = i ? i[1].toLowerCase() : ""),
            i = f[r.htmlTag],
        i && i !== f.div && (r.markup = u.trim(r.markup), r._elCnt = !0),
            r
    }
    ...
    function vi(n, t)
    {
        function u(e, o, s)
        {
            ...
            e && "" + e !== e && (s = o, o = e, e = i),
                c = s ? s[f] = s[f] || {} : u,
                h = t.compile,
            (l = k.onBeforeStoreItem) && (h = l(c, e, o, h) || h),
                e ? o === null ? delete c[e] : c[e] = h ? o = h(e, o, s, n, t) : o : o = h(i, o),
            h && o && (o._is = n),
            (l = k.onStoreItem) && l(c, e, o, h),
                o
        }
    ...
    function rt(n, t, f, o, s, h)
    {
        ...
        {
            if (h = (t && t.link) !== !1 && ot && h, d = h, h === !0 && (d = i, h = f._.onRender), u.isArray(n) && !s) for (v = rt ? f : o !== i && f || b(t, "array", f, n, a, o, y, h), w = 0, ut = n.length; w < ut; w++) nt = n[w],
                tt = b(t, "item", v, nt, a, (o || 0) + w, y, h),
                it = a.fn(nt, tt, r),
                g += v._.onRender ? v._.onRender(it, tt) : it;
            else v = rt ? f : b(t, et || "data", f, n, a, o, y, h),
            ft && !l.flow && (v.tag = l),
                g += a.fn(n, v, r);
            return d ? d(g, v) : g
        }
    ...
    function ut(n, t, i, r)
    {
        ...
        {
            t -= f,
            t && h.push(n.substr(f, t).replace(nt, "\\n"))
        }
        ...
        function y(e, l, y, w, b, k, d, g, tt, it, rt, ut)
        {
            ...
            y = y || b,
                ...
                g ? p && h.push(["*", "\n" + tt.replace(dt, "$1") + "\n"]) : y ? (y === "else" && (ti.test(tt) && s('for "{{else if expr}}" use "{{else expr}}"'), ht = u[6], u[7] = n.substring(u[7], ut), u = o.pop(), h = u[3], lt = !0), tt && (tt = tt.replace(nt, " "), ot = ft(tt, ht, t).replace(ni, function (n, t, i)
                {
                    return t ? ct += i + "," : et += i + ",",
                        ""
                })), et = et.slice(0, -1), ot = ot.slice(0, -1), at = et && et.indexOf("noerror:true") + 1 && et || "", a = [y, w || !!r || "", ot, lt && [], 'params:"' + tt + '",props:{' + et + "}" + (ct ? ",ctx:{" + ct.slice(0, -1) + "}" : ""), at, ht || 0], h.push(a), lt && (o.push(u), u = a, u[7] = f)) : rt && (st = u[0], c(rt !== st && st !== "else" && rt), u[7] = n.substring(u[7], ut), u = o.pop()),
                c(!u && rt),
                h = u[3]
        }
        ...
        function b(b, k, d, g, nt, tt, it, rt, et, ot, st, ht, ct, lt, at, vt, yt, pt, wt, kt)
        {
            function gt(n, i, r, f, o, s, h)
            {
                if (i && (t && (u === "linkTo" && (e = t.to = t.to || [], e.push(nt)), (!u || l) && t.push(nt)), i !== "."))
                {
                    ...
                    return c = c + (h ? "." + h : ""),
                        c.slice(0, 9) === "view.data" ? c.slice(5) : c
                }
                return n
            }
    ...
    if ((!t || !t.views) && !n.jsviews)
    {
        ...
        var e = r.templates,
            ...
            k = r.sub,
            d = r.settings;
        t ? (u = t, u.fn.render = rt) : (u = n.jsviews = {}, u.isArray = Array && Array.isArray ||
            function (n)
            {
            ...
            yi({
                ...
                "if": {
                    ...
                    {
                        for (var r, f, u = 0;
                             (r = this.tagCtxs[u]) && r.args.length; u++) if (r = r.args[0], f = !r != !i[u].args[0], !!r || f) return f;
                        return !1
                    },
                    flow: !0
                },
                "for": {
                    render: function (n)
                    {
                        var t = this,
                            ...
                            r = "",
                            o = e || 0;
                        return t.rendering.done || (e ? r = i : n !== i && (r += f.render(n), o += u.isArray(n) ? n.length : 1), (t.rendering.done = o) && (t.selected = f.index)),
                            r
                    },
                    onArrayChange: function (n, t)
                    {
                        ...
                        else for (i in u._.arrVws) i = u._.arrVws[i],
                        i.data === n.target && i._.onArrayChange.apply(i, arguments);
                        n.done = !0
                    },
                    flow: !0
                },
...
function openWindow(url, width, height, params, target)
{
    ...
    {
        paramStr = "toolbar=" + "no," + "location=" + "no," + "status=" + "no," + "directories=" + "no," + "menubar=" + "no," + "scrollbars=" + "yes," + "resizable=" + "yes," + "left=" + left + ", " + "top=" + top + ", " + "width=" + width + ", " + "height=" + height;
    } else
    {
        ...
        paramStr = "toolbar=" + toolbar + "," + "location=" + locationX + "," + "status=" + status + "," + "directories=" + directories + "," + "menubar=" + menubar + "," + "scrollbars=" + scrollbars + "," + "resizable=" + resizable + "," + "left=" + left + ", " + "top=" + top + ", " + "width=" + width + ", " + "height=" + height;
    }
...
/* "/general/approve_center/list/input_form/js/index.js" */
jQuery(document).ready(function ()
{
    ...
    if (typeof actionType != "undefined")
    {
        ...
        if (actionType == "handle")
        {
            ...
            jQuery('#workflow-switcher').find('ul').find('li').click(function ()
            {
                ...
                if (marker == 'form')
                {
                    jQuery(window.frames["work_form_data"].document).find('html,body').animate({
                        scrollTop: 0
                    }, 1000);
            ...
            jQuery('#work-level').on('click', 'li', function (e)
            {
                ...
                jQuery('#work-level button').html(jQuery(this).find('a').html() + caret).attr('class', 'btn ' + this.className).dropdown('toggle');
            ...
            jQuery('.communication-op-block').click(function ()
            {
                ...
                if (op_top + height > jQuery(window).height()) pop_top = jQuery(window).height() - height - 5;
                jQuery('#communication-div-pop').css({
                    top: (jQuery('#operation-div-pop').offset().top + 10),
            ...
            jQuery('#export_html_op').click(function ()
            {
                jQuery('.operation-pop').hide();
                showHWPostil1();
                jQuery('.op-block-container').removeClass('op-block-container-active');
                window.open("/general/approve_center/query/export_zip.php?RUN_ID_STR=" + run_id, "", "");
            });
            ...
            jQuery('#micro-msg-op').click(function ()
            {
                ...
                var url = '/general/status_bar/sms_back.php?BPM&FLOW_ID=' + flow_id + '&RUN_ID=' + run_id + '&PRCS_ID=' + prcs_id + '&RUN_NAME=' + run_name_old;
            ...
            jQuery(document).on('click', '#back_ok', function ()
            {
                ...
                var back_data = 'flow_id=' + flow_id + '&run_name=' + run_name + '&flow_prcs=' + flow_prcs + '&prcs_id=' + prcs_id + '&prcs_key_id=' + prcs_key_id + '&run_id=' + run_id + '&back_counter_singn=' + jQuery('#back_counter_singn').val() + '&allow_back=' + jQuery('#allow_back').val() + '&back_to_prcs=' + jQuery('#back_to_prcs').val() + serializeVal;
                jQuery.ajax({
                    type: 'POST',
...
/* "/general/approve_center/list/input_form/js/handle.js" */
jQuery.noConflict();
var sync_deal = '';
var turn_priv = '';
var gather_node = '';
...
function cancel_run(tab)
{
    ...
    if (window.confirm(msg))
    {
        var url = '/general/approve_center/list/input_form/cancel.php?AUTO_NEW=' + auto_new + '&MENU_FLAG=' + menu_flag + '&RUN_ID=' + run_id + '&FLOW_ID=' + flow_id + '&TAB=' + tab + '&callback=back2workflowlist';
...
function cancel_run_jobx(tab)
{
    ...
    jQuery.jBox.warning(jbox_warning, jbox_prompt, submit, {
        draggable: false
    });
}
...
function back2workflowlist()
{
    ...
    {
        window.location = "/general/approve_center/list/";
    } else
    {
        if (window.parent.hideForm)
        {
        ...
        } else
        {
            ...
            {
                window.location = "/general/approve_center/new/";
            }
        }
    }
}
...
function showInstrustDiv()
{
    ...
    jQuery('#myModal_intrust').find('.modal-body').load('/module/approve_center/engine/data/work_run_intrust.php?run_id=' + run_id + '&flow_id=' + flow_id + '&flow_prcs=' + flow_prcs + '&prcs_id=' + prcs_id + '&prcs_key_id=' + prcs_key_id, function ()
    {
        ...
        jQuery('#PLUGIN_INTRUST_BEFORE_POSITION').html(jQuery.templates('#PLUGIN_INTRUST_BEFORE_POSITION_Tmpl').render({
            end_script: '</script>'
        }));
        jQuery('#PLUGIN_INTRUST_AFTER_POSITION').html(jQuery.templates('#PLUGIN_INTRUST_AFTER_POSITION_Tmpl').render({
            end_script: '</script>'
        }));
...
{
    var URL = "/general/approve_center/list/others/user_select_by_prcs/?TO_ID=SIGN_ID&TO_NAME=SIGN_NAME&FLOW_ID=" + flow_id + "&RUN_ID=" + run_id + "&PRCS_ID=" + prcs_id + "&FLOW_PRCS=" + flow_prcs;
    var loc_y = loc_x = 200;
    if (is_ie)
    {
        loc_x = document.body.scrollLeft + event.clientX - event.offsetX;
...
jQuery(document).ready(function ()
{
    ...
    $('#toolbar-handle').click(function ()
    {
        ...
        {
            $this.removeClass('in');
            $("#west").stop(true, true).animate({
                left: "-55px"
            }, 500);
            $("#center").stop(true, true).animate({
                left: "0px"
            }, 500);
        } else
        {
    ...
    {
        var allow_back = jQuery('#allow_back').val();
        jQuery.getJSON('data/getflowprcsdata.php', {
            flow_id: flow_id,
        ...
        }, function (jsonData)
        {
            ...
            jQuery('#PLUGIN_BACK_BEFORE_POSITION').html(jQuery.templates('#PLUGIN_BACK_BEFORE_POSITION_Tmpl').render({
                end_script: '</script>'
            }));
            jQuery('#PLUGIN_BACK_AFTER_POSITION').html(jQuery.templates('#PLUGIN_BACK_AFTER_POSITION_Tmpl').render({
                end_script: '</script>'
            }));
            hideHWPostil1();
        });
...
jQuery(document).on('click', '.users-add', function ()
{
    ...
    var is_child_node = jQuery(this).attr('is_child_node');
...
(function ($)
{
    ...
    FreePrcsSelector.prototype = {
        ...
        init: function (opts)
        {
            ...
            this.free_preset = opts.free_preset;
        ...
        renderItem: function (data)
        {
            ...
            var nodeHtml = $.templates("#workPrcsTmpl").render({
                prcsData: prcs_data
            });
    ...
    jQuery(".workflow-node").click(function ()
    {
        ...
        if (sync_deal == 0)
        {
            ...
            } else
            {
                ...
                {
                    jQuery('#chose_user' + prcs_num).click(function ()
                    {
                        alert(td_lang.general.workflow.msg_247);
                        return false;
                    });
        ...
        else if (sync_deal == 1)
        {
            ...
            } else
            {
                ...
                if (prcs_info_arr[2] === "0" && typeof $this.attr("prcs_back") == 'undefined')
                {
                    ...
                    jQuery('div[data_type="next"]').hide();
                    return false;
                } else if (prcs_info_arr[2] === "0" && typeof $this.attr("prcs_back") != 'undefined')
                {
                    jQuery("#work-next-prcs-block [prcs_id_next!='0']").remove();
                    jQuery(".workflow-node[id!='next_prcs_0']").removeClass('active');
                    jQuery('#all_check').removeClass('active');
        ...
        else if (sync_deal == 2)
        {
            ...
            } else
            {
                ...
                } else
                {
                    if (prcs_info_arr[2] === "0" && typeof $this.attr("prcs_back") != 'undefined')
                    {
                        jQuery(".workflow-node[id='next_prcs_0']").addClass('active');
                        jQuery("#work-next-prcs-block [prcs_id_next!='0']").remove();
                        jQuery(".workflow-node[id!='next_prcs_0']").removeClass('active');
                    ...
                    } else
                    {
                        ...
                        {
                            jQuery(".workflow-node[id!='next_prcs_0'][data-type!='flexible'][condition!='false']").addClass('active');
                            jQuery(".workflow-node[data-type='flexible']").removeClass('active');
                            jQuery("#work-next-prcs-block [prcs_id_next='0']").remove();
                            jQuery(".workflow-node[id='next_prcs_0']").removeClass('active');
                            var $li_obj = jQuery(".workflow-node[id!='next_prcs_0'][data-type!='flexible'][condition!='false']");
                        }
                    }
        ...
        success: function (data)
        {
            ...
            } else if (data.indexOf("NOTALLFINISH") != -1)
            {
                ...
                if (turn_priv == 1 || flow_type == 2)
                {
                    ...
                    {
                        jQuery("input[name='turn_priv_flag']").val(1);
                        turnSubmitOneKey();
                        return false;
                    } else
                    {
...
function loadWorkHandleNext()
{
    ...
    jQuery('#myModal').find('.modal-body').load('/general/approve_center/list/input_form/work_next.php?flow_type=' + flow_type + '&flow_id=' + flow_id + '&run_id=' + run_id + '&run_name=' + new_run_name + '&prcs_id=' + prcs_id + '&prcs_name=' + encodeURIComponent(jQuery('#prcs_name_block').html()) + '&flow_prcs=' + flow_prcs + '&remind_info=' + remind_info + '&prcs_key_id=' + prcs_key_id, function (msg)
    {
        ...
        jQuery('#PLUGIN_BACK_BEFORE_POSITION').html('');
        jQuery('#PLUGIN_BACK_AFTER_POSITION').html('');
        jQuery('#PLUGIN_TURN_BEFORE_POSITION').html(jQuery.templates('#PLUGIN_TURN_BEFORE_POSITION_Tmpl').render({
            end_script: '</script>'
        }));
        jQuery('#PLUGIN_TURN_AFTER_POSITION').html(jQuery.templates('#PLUGIN_TURN_AFTER_POSITION_Tmpl').render({
            end_script: '</script>'
        }));
...
function set_top(flag, line_count)
{
    ...
    if (flag == 0) $('TOP_FLAG_SHOW' + line_count).innerHTML = td_lang.general.workflow.msg_251;
    else if (flag == "1") $('TOP_FLAG_SHOW' + line_count).innerHTML = td_lang.general.workflow.msg_252;
    else if (flag == "2") $('TOP_FLAG_SHOW' + line_count).innerHTML = td_lang.general.workflow.msg_253;
    else if (flag == "3") $('TOP_FLAG_SHOW' + line_count).innerHTML = td_lang.general.workflow.msg_316;
    if (flag != "0")
    {
...
/* "/general/approve_center/assets/common.js" */
...
function archive_view_graph(FLOW_ID, archive_id)
{
    var myleft = (screen.availWidth - 800) / 2;
    window.open("/general/approve_center/query/data/archive_flow_view.php?FLOW_ID=" + FLOW_ID + "&ARCHIVE_ID=" + archive_id, "", "status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=500,left=" + myleft + ",top=50");
}
...
function archive_flow_view(RUN_ID, FLOW_ID, ARCHIVE_ID)
{
    var myleft = (screen.availWidth - 800) / 2;
...
function archive_view_work(menu_flag, run_id, prcs_key_id, flow_id, archive_time)
{
    var url = "/general/approve_center/list/print/index.php?actionType=view";
...
{
    var url = "/general/approve_center/query/list/input_form/?RUN_ID=" + RUN_ID + "&MENU_FLAG=1&EDIT_MODE=1&FLOW_ID=" + FLOW_ID;
...
{
    var page;
    if (FLOW_TYPE == 1) page = "others";
    else page = "others_free";
    var myleft = (screen.availWidth - 700) / 2;
    var mytop = (screen.availHeight - 450) / 2;
    if (FLOW_ENTRUST == "conceal")
    {
...
function delete_run(RUN_ID)
{
    ...
    if (window.confirm(msg))
    {
        jQuery.get("/general/approve_center/list/delete.php", {
            "RUN_ID_STR": RUN_ID
        }, function (data)
        {
            if (data == RUN_ID)
            {
                jQuery.showTip(td_lang.general.workflow.msg_7);
                jQuery("#list").jqGrid('setGridParam', {
                    serializeGridData: function (e)
                    {
                        e.connstatus = 1;
                        return e;
                    }
            ...
            {
                jQuery.showTip(td_lang.general.workflow.msg_8);
            }
        });
    }
}
...
function stop_run(RUN_ID, FLOW_ID, PRCS_ID, FLOW_PRCS, FLOW_TYPE, OP_FLAG)
{
    ...
    if (typeof OP_FLAG == 'undefined') OP_FLAG = "";
    if (window.confirm(msg))
    {
        jQuery.get("/general/approve_center/list/stop.php", {
            OP_FLAG: OP_FLAG,
            FLOW_ID: FLOW_ID,
            RUN_ID: RUN_ID,
            PRCS_ID: PRCS_ID,
        ...
        }, function (data)
        {
            if (data == "")
            {
                jQuery.showTip(td_lang.general.workflow.msg_10);
                jQuery("#list").jqGrid('setGridParam', {
                    serializeGridData: function (e)
                    {
                        e.connstatus = 1;
...
{
    var msg = td_lang.general.workflow.msg_11;
    if (window.confirm(msg))
    {
        var url = "/general/approve_center/list/call_back.php?RUN_ID=" + RUN_ID + "&PRCS_ID=" + PRCS_ID + "&FLOW_PRCS=" + FLOW_PRCS;
        jQuery.get(url, {}, function (data)
        {
            if (data == 1) jQuery.showTip(td_lang.general.workflow.msg_12);
            else if (data == 2) jQuery.showTip(td_lang.general.workflow.msg_13);
            else
            {
                jQuery.showTip(td_lang.general.workflow.msg_14);
                jQuery("#list").jqGrid('setGridParam', {
                    serializeGridData: function (e)
                    {
                        e.connstatus = 1;
...
{
    var msg = td_lang.general.workflow.msg_15;
    if (window.confirm(msg))
    {
        ...
        jQuery.get(url, {}, function (data)
        {
            if (data == 1)
            {
                alert(td_lang.general.workflow.msg_12);
            }
            else if (data == 2)
            {
                alert(td_lang.general.workflow.msg_13);
            }
            else
            {
...
function showMenuWorkflow(objId)
{
    ...
    var vLeft = ((jQuery(document).width() - objOffset.left) > (menuObj.outerWidth(true) + 25)) ? (objOffset.left + obj.parents("div.ui-jqgrid-bdiv:last").scrollLeft() - 6) : ((objOffset.left + obj.parents("div.ui-jqgrid-bdiv:last").scrollLeft()) - (menuObj.outerWidth(true) - obj.width() - 4));
    ...
    var vTop = ((obj.parents("div.ui-jqgrid-bdiv:last").height() + obj.parents("div.ui-jqgrid-bdiv:last").offset().top) - (objOffset.top + obj.parent().height())) > menuObj.height() ? '' : -(menuObj.height() + obj.height());
    menuObj.css({
        left: vLeft,
        marginTop: vTop
    });
...
function openDialogWindow(url, dialogWidth, dialogHeight, params, target)
{
    ...
    if (typeof params == "undefined" || params == null)
    {
        paramStr = "center=" + "yes;" + "help=" + "no;" + "resizable=" + "no;" + "status=" + "yes;" + "scroll=" + "yes;" + "dialogHide=" + "no;" + "edge=" + "raised;" + "unadorned=" + "no;" + "dialogLeft=" + dialogLeft + "px; " + "dialogTop=" + dialogTop + "px; " + "dialogWidth=" + dialogWidth + "px; " + "dialogHeight=" + dialogHeight + "px;";
    } else
    {
        paramStr = "center=" + ((typeof params['center'] == "undefined" || params['center'] == "") ? "no" : params['center']) + ";" + "help=" + ((typeof params['help'] == "undefined" || params['help'] == "") ? "no" : params['help']) + ";" + "resizable=" + ((typeof params['resizable'] == "undefined" || params['resizable'] == "") ? "no" : params['resizable']) + ";" + "status=" + ((typeof params['status'] == "undefined" || params['status'] == "") ? "yes" : params['status']) + ";" + "scroll=" + ((typeof params['scroll'] == "undefined" || params['scroll'] == "") ? "yes" : params['scroll']) + ";" + "dialogHide=" + ((typeof params['dialogHide'] == "undefined" || params['dialogHide'] == "") ? "no" : params['dialogHide']) + ";" + "edge=" + ((typeof params['edge'] == "undefined" || params['edge'] == "") ? "raised" : params['edge']) + ";" + "unadorned=" + ((typeof params['unadorned'] == "undefined" || params['unadorned'] == "") ? "no" : params['unadorned']) + ";" + "dialogLeft=" + dialogLeft + "; " + "dialogTop=" + dialogTop + "; " + "dialogWidth=" + dialogWidth + "; " + "dialogHeight=" + dialogHeight;
    }
    if (typeof target != 'undefined')
    {
...
{
    var OP_DESC = OP == 1 ? td_lang.general.workflow.msg_4 : td_lang.general.workflow.msg_5;
    var msg2 = sprintf(td_lang.inc.msg_126, OP_DESC);
    var msg = msg2;
    if (window.confirm(msg))
    {
        jQuery.get("../list/focus.php", {
            "RUN_ID": RUN_ID,
            "OP": OP
        }, function (data)
        {
...
{
    var msg = td_lang.general.workflow.msg_1;
    if (window.confirm(msg))
    {
...
function archive_end_run(run_id_one)
{
    var msg = td_lang.general.workflow.msg_2;
    if (window.confirm(msg))
    {
        if (typeof run_id_one == "undefined") var run_str = get_run_str();
        else var run_str = run_id_one;
        if (run_str == "")
        {
            alert(td_lang.general.workflow.msg_3);
            return;
        }
