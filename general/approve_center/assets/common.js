...
{
    var myleft=(screen.availWidth-800)/2;
   // window.open("/general/approve_center/query/data/flow_view/?RUN_ID="+RUN_ID+"&FLOW_ID="+FLOW_ID+"&ARCHIVE_ID="+ARCHIVE_ID,RUN_ID,"status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=400,left="+myleft+",top=100");
