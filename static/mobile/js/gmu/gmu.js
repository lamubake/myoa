...
(function( gmu, $, undefined ) {
    ...
    gmu.define( 'Refresh', {
        ...
        _createBtn: function (dir) {
            this._options['$' + dir + 'Elem'].html('<span class="ui-refresh-icon"></span><span class="ui-refresh-label">'+td_lang.pda.msg_6 || "加载更多"+'</span>');
        ...
        _changeStyle: function (dir, state) {
            ...
            switch (state) {
                case 'loaded':
                    ...
                    break;
                case 'loading':
                    refreshInfo['$label'].html(td_lang.pda.msg_2 || '加载中...');
                    refreshInfo['$icon'].addClass('ui-loading');
                    opts._actDir = dir;
                    break;
                case 'disable':
                    refreshInfo['$label'].html(td_lang.pda.msg_1 || '没有更多内容了');
                    break;
            }
        ...
        _changeStyle: function (dir, state) {
            ...
            switch (state) {
                case 'loaded':
                    ...
                    break;
                case 'beforeload':
                    refreshInfo['$label'].html(td_lang.pda.msg_7 || '松开立即加载');
