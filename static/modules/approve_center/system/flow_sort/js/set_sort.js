	...
	if(sort_id=='0'){
		jQuery.post('flow/check_name.php',{'sort_name':sort_name,'sort_parent':sort_parent},function(data){
			if(data=='1'){		
				...
				jQuery.post('flow/save.php',{'sort_parent':sort_parent,'sort_no':sort_no,'sort_name':sort_name,'dept_id':dept_id,'flow_dept_id_old':flow_dept_id_old},function(data){
					if(data!=='0'){					
						jQuery('#process_form').load('flow/index.php',function(){});
		...
		if(old_name!==sort_name){
			jQuery.post('flow/check_name.php',{'sort_name':sort_name,'sort_parent':sort_parent},function(data){
				if(data=='1'){		
					...
					jQuery.post('flow/save.php',{'sort_parent':sort_parent,'sort_no':sort_no,'sort_name':sort_name,'dept_id':dept_id,'sort_id':sort_id,'have_child':have_child,'flow_parent':sort_old_parent,'flow_dept_id_old':flow_dept_id_old},function(data){
						jQuery('#process_form').load('flow/index.php',function(){});
