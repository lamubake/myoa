...
function td_addnew_multiple(lv_tb_id,read_only,row_value,is_del)
{
...
function tb_addnew(lv_tb_id,read_only,row_value,is_del)
{
    ...
    if(sum_flag==1 && mytable.rows.length==2)
        tb_add_sum(lv_tb_id,sum,sum_flag,cal);
}
...
function create_qr(item_id)
{
    ...
    if(data_value != "")
    {
        var url = "/general/approve_center/list/input_form/create_qr.php?data_value="+data_value;
