...
//-- 模块对应ID固定 --
var moduleInfo = {"email":1,"notify":4,"news":147,"vote":119,"workflow":5,"calendar":8,"diary":9||81,"attendance":7,"bbs":62,"file_folder":15,"reportshop":550};
var moduleInfoIndex = {"a1":"email","a4":"notify","a147":"news","a119":"vote","a5":"workflow","a8":"calendar","a9":"diary","a81":"diary","a7":"attendance","a62":"bbs","a15":"file_folder","a550":"reportshop"};

//-- 可用菜单图标 --
var availappicon = ['address','asset','attendance','bbs','book','calendar','comm','crm','default','diary','document','email','erp','exam_manage','fax','file_folder','hr','info','itask','meeting','mytable','netdisk','news','notify','person_info','picture','project','reportshop','roll_manage','score','sms','system','todo','training','vehicle','vote','wiki','work_plan','workflow','report'];

var default_icon = 'default';
var s_default_icon = 'oa';
var rowAppNum = 8;
//字体图标对象 sxm 2014-12-22
var module2iconfont  = {
    "01": "&#xe653;",
    "02": "",
    "10": "&#xe65a;",
...
(function($){
   ...
   function returnFmenu()
   {
      ...
      html += '<li><a id="extWebApp" href="javascript:;" hidefocus="hidefocus" title='+td_lang.inc.msg_74+'><i class="appbox appbox_icons">&#xe67a;</i> '+td_lang.inc.msg_74+'</a></li>';//"互联网应用"
      html += '<li><a id="extFav" href="javascript:;" hidefocus="hidefocus" title='+td_lang.inc.personfav+'><i class="fav appbox_icons">&#xe679;</i> '+td_lang.inc.personfav+'</a></li>';//"个人收藏"
      return html;
   }
